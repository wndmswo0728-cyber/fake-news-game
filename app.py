...
SAMPLE_ARTICLES = [
    ("정부, 2026년부터 모든 공공기관 주 4.5일제 시범 도입",
     ...
     "fake", "\u2022 발표 주체: 행정안전부(공무원 인사 담당 부처)\n\u2022 정책 범위: 시범 도입으로 한정, 전면 시행 아님\n\u2022 구체적 일정(2026 하반기)과 기간(6개월) 명시", "행정안전부는 주 4.5일제 시범 도입을 공식 발표한 적이 없습니다.", "hard"),
    ("SK하이닉스, HBM4 양산 시작… 엔비디아 차세대 GPU에 독점 공급",
     ...
     "real", "\u2022 HBM4는 업계에서 개발 중인 차세대 메모리 규격명\n\u2022 SK하이닉스-엔비디아 간 기존 공급 관계 존재\n\u2022 성능 향상 수치(2배)는 세대 간 일반적 개선폭", "SK하이닉스는 실제로 HBM4 양산과 엔비디아 공급 계약을 발표했습니다.", "easy"),
    ("서울대 연구팀, 상온 초전도체 재현 실험 성공 논문 발표",
     ...
     "fake", "\u2022 게재 학술지: Nature(피어리뷰 저널)\n\u2022 LK-99는 2023년 한국 연구팀이 발표한 물질명\n\u2022 전기저항 0 수렴은 초전도 판정의 핵심 측정값", "LK-99의 초전도 현상은 전 세계 재현 실험에서 확인되지 않았습니다.", "hard"),
    ("카카오뱅크, 26세 이하 대상 신용대출 금리 연 2.9% 상품 출시",
     ...
     "real", "\u2022 카카오뱅크: 금융위 인가 인터넷전문은행\n\u2022 청년 대상 저금리 상품은 시중은행에서도 운영 중\n\u2022 대출 한도 3,000만원은 신용대출 일반 범위 내", "카카오뱅크는 실제로 청년 대상 저금리 신용대출 상품을 운영하고 있습니다.", "easy"),
    ("국토부, 수도권 신규 택지 30만 가구 공급 계획 발표",
     ...
     "fake", "\u2022 발표 주체: 국토교통부(주택 정책 담당)\n\u2022 30만 가구는 3기 신도시급 대규모 물량\n\u2022 2030년 입주 목표와 공공분양 40% 비율 명시", "이 규모의 신규 택지 지정 발표는 실제로 이루어지지 않았습니다.", "hard"),
    ("LG에너지솔루션, 전고체 배터리 파일럿 라인 가동 시작",
     ...
     "real", "\u2022 LG에너지솔루션: 글로벌 배터리 제조사\n\u2022 전고체 배터리: 차세대 기술로 업계 공통 개발 중\n\u2022 파일럿 라인은 양산 전 시험 생산 단계 의미", "LG에너지솔루션은 실제로 전고체 배터리 파일럿 라인 가동을 발표했습니다.", "easy"),
    ("금융위, 가상자산 거래소 이용자 보호법 시행령 확정",
     ...
     "real", "\u2022 금융위원회: 금융 규제 담당 정부 기관\n\u2022 가상자산 이용자 보호법: 2024년 시행된 법률\n\u2022 콜드월렛 보관 비율, 거래 정지 조치는 시행령 세부사항", "가상자산 이용자 보호법 시행령은 실제로 확정 시행되었습니다.", "easy"),
    ("현대차, 아이오닉 9에 레벨4 자율주행 기본 탑재 공식 발표",
     ...
     "fake", "\u2022 아이오닉 9: 현대차가 예고한 실제 차량명\n\u2022 레벨4: 특정 조건에서 완전 자율주행 단계\n\u2022 기본 사양 탑재는 옵션이 아닌 전 차량 적용 의미", "현대차는 아이오닉 9에 레벨4 자율주행 기본 탑재를 발표한 적이 없습니다.", "hard"),
    ("질병관리청, 65세 이상 대상 RSV 백신 무료 접종 시작",
     ...
     "real", "\u2022 질병관리청: 감염병 예방접종 담당 기관\n\u2022 RSV 백신: 2023년 FDA 승인된 실존 백신\n\u2022 고령자 무료 접종: 국가예방접종 사업 형태", "질병관리청은 실제로 고령자 대상 RSV 백신 접종 사업을 시행하고 있습니다.", "easy"),
    ("네이버, 자체 AI 반도체 양산 돌입… TSMC 4나노 공정 위탁",
     ...
     "fake", "\u2022 네이버: AI 서비스 기업(소프트웨어 중심)\n\u2022 TSMC 4나노: 실존하는 파운드리 공정\n\u2022 자체 반도체 개발은 빅테크 트렌드(구글 TPU, 아마존 Graviton)", "네이버는 자체 AI 반도체를 양산한다고 발표한 적이 없습니다.", "hard"),
    ("한수원, 소형모듈원전(SMR) 건설 허가 원안위에 신청",
     ...
     "real", "\u2022 한수원: 국내 원전 운영 공기업\n\u2022 SMR: 전 세계적으로 개발 중인 차세대 원전 기술\n\u2022 원안위 건설 허가: 원전 건설의 법적 필수 절차", "한수원은 실제로 SMR 건설 허가를 신청하며 차세대 원전 사업을 추진하고 있습니다.", "easy"),
    ("교육부, 2027학년도부터 수능 전 과목 절대평가 전환 확정",
     ...
     "fake", "\u2022 교육부: 수능 제도 관할 부처\n\u2022 절대평가 전환: 수년간 논의된 정책 방향 중 하나\n\u2022 등급 축소(9->5)와 본고사 금지는 구체적 제도 변경 내용", "교육부는 2027학년도 수능 전면 절대평가 전환을 확정 발표한 적이 없습니다.", "hard"),
    ("삼성바이오로직스, FDA로부터 바이오시밀러 3종 동시 승인",
     ...
     "real", "\u2022 삼성바이오로직스: 글로벌 바이오 CMO/CDO 기업\n\u2022 FDA 바이오시밀러 승인: 공시 의무 사항\n\u2022 자가면역질환 바이오시밀러: 고성장 시장 분야", "삼성바이오로직스는 실제로 FDA 바이오시밀러 승인을 받아 미국 시장에 진출하고 있습니다.", "easy"),
    ("과기정통부, 민간 우주발사체 발사 허가제 시행",
     ...
     "real", "\u2022 과기정통부: 우주 정책 담당 부처\n\u2022 우주활동법: 2024년 시행된 법률\n\u2022 민간 발사 허가제: 해외(미국 FAA) 선례 존재", "우주활동법 시행령은 실제로 공포되어 민간 우주발사 허가 체계가 마련되었습니다.", "easy"),
    ("KT, 6G 상용 서비스 2026년 하반기 세계 최초 개시 선언",
     ...
     "fake", "\u2022 6G: 현재 3GPP 표준화 이전 연구 단계\n\u2022 1Tbps: 학술 논문에서 언급되는 6G 이론적 목표치\n\u2022 세계 최초 상용화 선언: 통신사 마케팅에서 사용되는 표현 유형", "6G는 아직 표준화 단계에 있으며, 2026년 상용화는 기술적으로 불가능합니다.", "hard"),
    ("국민연금, 2025년 기금 운용 수익률 12.3% 달성",
     ...
     "real", "\u2022 국민연금: 세계 3위 규모 연기금\n\u2022 연간 수익률 12%대: 주식시장 호황기 달성 가능 범위\n\u2022 해외 주식 비중 확대: 공개된 자산배분 전략 방향", "국민연금은 실제로 2025년 높은 수익률을 기록하며 기금 규모가 확대되었습니다.", "easy"),
    ("토스, 자체 신용평가 모델로 은행권 대출 심사 단독 대체 허가 획득",
     ...
     "fake", "\u2022 토스: 핀테크 기업(종합금융플랫폼)\n\u2022 신용평가 시장: NICE, KCB 과점 구조\n\u2022 단독 사용 허가: 기존 규제 체계의 근본적 변경에 해당", "금융위는 특정 기업에 신용평가 단독 사용 허가를 부여한 적이 없습니다.", "hard"),
    ("포스코, 호주 리튬 광산 지분 30% 인수 완료",
     ...
     "real", "\u2022 포스코홀딩스: 2차전지 소재 사업 진출 기업\n\u2022 호주 필바라: 실제 리튬 광산 밀집 지역\n\u2022 지분 인수: 공시 의무 사항(금액/비율 명시)", "포스코는 실제로 호주 리튬 광산 지분을 인수하며 배터리 소재 사업을 확대하고 있습니다.", "easy"),
    ("방통위, 유튜브에 국내 뉴스 콘텐츠 사용료 지급 의무화 고시 확정",
     ...
     "fake", "\u2022 방통위: 방송/통신 규제 기관\n\u2022 뉴스 사용료 의무화: 호주/캐나다에서 시행된 정책 유형\n\u2022 매출 3% 과징금: 디지털 플랫폼 규제에서 사용되는 제재 수준", "방통위는 유튜브에 뉴스 사용료 지급을 의무화하는 고시를 확정한 적이 없습니다.", "hard"),
]
START_TEMPLATE = """
<!DOCTYPE html>
<html>
...
{% if last_correct %}
{% if last_label == "fake" %}
<div class="result-box correct">🎯 You caught the fake! 좋은 판단력입니다.</div>
{% else %}
<div class="result-box correct">✅ Correct! 진짜 뉴스를 정확히 구별했습니다.</div>
{% endif %}
{% else %}
{% if last_label == "fake" %}
<div class="result-box wrong">😈 This headline fooled you. 이 기사는 가짜였습니다.</div>
{% else %}
<div class="result-box wrong">🤔 Tricked! 의심했지만 이건 실제 뉴스였습니다.</div>
{% endif %}
{% endif %}
...
def init_db():
    ...
    try:
        ...
        if count == 0:
            cursor.executemany(
                "INSERT INTO articles (title, content, label, hint, explanation, difficulty) VALUES (?, ?, ?, ?, ?, ?)",
                SAMPLE_ARTICLES,
            )
            conn.commit()
    except Exception as e:
